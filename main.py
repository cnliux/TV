...
async def main():
    ...
    try:
        ...
        # 按模板排序并优先白名单频道
        include_uncategorized = config.getboolean('EXPORTER', 'include_uncategorized', fallback=False)
        sorted_channels = matcher.sort_channels_by_template(filtered_channels, whitelist, include_uncategorized)
